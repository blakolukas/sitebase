...
Install procergs.sitebase with uv.

```shell
uv add procergs.sitebase
```
...
- [Issue tracker](https://github.com/procergs/sitebase/issues)
- [Source code](https://github.com/procergs/sitebase/)
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-05-08 13:01:41.. A special thanks to all contributors and supporters!
